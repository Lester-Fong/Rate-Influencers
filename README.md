...
<table>
  <tr>
    <td width="50%">
      <img src="./frontend/public/assets/public-home.png" alt="RateInfluencers public discovery page" />
    </td>
    <td width="50%">
      <img src="./frontend/public/assets/admin-dashboard.png" alt="RateInfluencers administrator dashboard" />
    </td>
  </tr>
  <tr>
